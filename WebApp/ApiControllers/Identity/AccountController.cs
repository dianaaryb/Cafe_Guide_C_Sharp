...
public class AccountController : ControllerBase
{
    ...
    {
        Console.WriteLine("in logj method");
        if (expiresInSeconds <= 0) expiresInSeconds = int.MaxValue;
        expiresInSeconds = expiresInSeconds < _configuration.GetValue<int>("JWT:expiresInSeconds")
            ? expiresInSeconds
            : _configuration.GetValue<int>("JWT:expiresInSeconds");
        ...
        Console.WriteLine("firstname: " + responseData.FirstName);
        Console.WriteLine("lastname: " + responseData.LastName);

        return Ok(responseData);
    }

    /// <summary>
    /// Refresh the authentication tokens for a user.
    /// </summary>
    /// <param name="tokenRefreshInfo">The current JWT and refresh token.</param>
    /// <param name="expiresInSeconds">Override jwt lifetime for testing.</param>
    /// <returns>JWTResponse - new jwt and refresh token</returns>
    [HttpPost]
    [Produces( "application/json")]
    [Consumes("application/json")]
    [ProducesResponseType<JWTResponse>((int) HttpStatusCode.OK)]
    ...
    /// </summary>
    /// <param name="logout">Information about the logout attempt, including the refresh token to invalidate.</param>
    /// <returns>Status indicating the result of the logout attempt.</returns>
